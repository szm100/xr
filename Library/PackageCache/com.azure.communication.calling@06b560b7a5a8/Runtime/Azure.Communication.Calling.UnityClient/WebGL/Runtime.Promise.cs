...
namespace Azure.Communication.Calling.UnityClient
{
    ...
    internal abstract class PromiseBase : IDisposable
    {
...
#if ENABLE_IL2CPP
        [AOT.MonoPInvokeCallback(typeof(sam_promise_on_complete))]
#endif
...
#if ENABLE_IL2CPP
        [AOT.MonoPInvokeCallback(typeof(sam_promise_on_error))]
#endif
...
#if ENABLE_IL2CPP
        [AOT.MonoPInvokeCallback(typeof(sam_promise_on_progress))]
#endif
        ...
        private static readonly sam_promise_on_complete OnCompleteDelegate = OnCompleteThunk;

        private static readonly sam_promise_on_error OnErrorDelegate = OnErrorThunk;

        private static readonly sam_promise_on_progress OnProgressDelegate = OnProgressThunk;
    }
    ...
    internal class Promise<T> : PromiseBase
    {
        ...
        private readonly TaskCompletionSource<T> taskCompletionSource = new TaskCompletionSource<T>(TaskCreationOptions.RunContinuationsAsynchronously);
