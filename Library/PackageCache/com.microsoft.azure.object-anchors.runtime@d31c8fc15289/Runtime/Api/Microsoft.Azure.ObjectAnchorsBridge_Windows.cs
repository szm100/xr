...
namespace Microsoft.Azure.ObjectAnchors
{
    ...
    public partial class ObjectQuery : IDisposable, ICachedObject, IReferenceCounted
    {
        ...
        {
            using (var promise_ = Microsoft.Azure.ObjectAnchors.Promise.Create(pv_ => pv_.Pointer != IntPtr.Zero ? Microsoft.Azure.ObjectAnchors.EnvironmentObservation.GetOrCreateInstance(pv_.Pointer, true) : default, System.Threading.CancellationToken.None))
            {
...
namespace Microsoft.Azure.ObjectAnchors.Diagnostics
{
    internal static partial class NativeLibrary
    {
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_object_diagnostics_session_create_object_observer_observer_uint32_max_session_size_in_mega_bytes_object_diagnostics_image_kind_image_kinds(IntPtr observer, uint max_session_size_in_mega_bytes, Microsoft.Azure.ObjectAnchors.Diagnostics.ObjectDiagnosticsImageKind image_kinds, out IntPtr instance);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
    ...
    /// </summary>
    public enum ObjectDiagnosticsImageKind : int
    {
        /// <summary>
        /// No images will be captured.
        /// </summary>
        None = 0,
        /// <summary>
        /// Captures RGB images from the photo/video camera.
        /// </summary>
        Color = 1,
        /// <summary>
        /// Captures illuminated infrared and depth images from the depth camera.
        /// </summary>
        Depth = 2,
        /// <summary>
        /// Captures all images.
    ...
    public partial class ObjectDiagnosticsSession : ICachedObject, IReferenceCounted
    {
        ...
        {
            Microsoft.Azure.ObjectAnchors.status resultStatus = (Microsoft.Azure.ObjectAnchors.Diagnostics.NativeLibrary.aoa_object_diagnostics_session_create_object_observer_observer_uint32_max_session_size_in_mega_bytes_object_diagnostics_image_kind_image_kinds(observer != null ? observer.handle : IntPtr.Zero, maxSessionSizeInMegaBytes, imageKinds, out this.handle));
            Microsoft.Azure.ObjectAnchors.NativeLibraryHelpers.CheckStatus(this.handle, resultStatus);
            Microsoft.Azure.ObjectAnchors.ProjectedObjectCache.Add(this);
        }
